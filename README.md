...
Il vecchio URL (`…/spid-saml2-federation-search-engine/`) non è più valido dopo il rename del repository; esiste un [repo di redirect](https://github.com/peppelinux/spid-saml2-federation-search-engine) che reindirizza qui.
